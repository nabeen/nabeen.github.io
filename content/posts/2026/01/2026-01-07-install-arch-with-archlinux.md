...
快適に使うために、いつも使っているアプリである Obsidian、Todoist を入れたり、AUR 用に `yay` を入れたりした。まぁここまで来たら他に詰みポイントはなさそうだし、いくらでもリカバリ可能なはず。

あとはランチャーも一応入れておいた。Reddit で見つけた Vicinae[^vicinae] というやつで、Raycast Inspired と書いてあったのでこれにした。仕事では mac で Raycast を使っているので、あんまり気にならないとは思うがコンテキストスイッチは小さいほうがいい。他にいいのがあれば乗り換えようとは思う。
...
...意外と思いつくものが少なかった。というか思いつくほど Linux に詳しくないんだな。とりあえず今年は Linux と仲良くなる年だと思っているので、ゆっくり遊んでいこうと思う。調べてると知らない単語もめちゃくちゃあるし。

一応この環境でも開発はするつもりだけど、IDE は入れないつもりなので、NeoVim 縛りで頑張っていくつもり。今まで避けてきたので、今年こそは。
